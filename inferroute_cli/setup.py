...
def run(rest=None) -> int:
    ...
    # Cowork (the optional goose-powered desktop app) is intentionally NOT part of
    # setup — most installs don't want it, and a prompt on every setup is noise.
    # It stays available on demand via `ir cowork` for the few who do.
